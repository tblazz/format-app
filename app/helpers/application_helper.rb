module ApplicationHelper
  ...
  def select_headers(initial_file_headers, header_index, format, col_in_final_header)
    ...
    freshstart_headers_array = [
      ...
      clas_array = ['Pl.', 'Class', 'Classement', 'POSITION'],
      prénom_array = ['', 'prénom'],
      nom_array = ['nom', 'Nom', 'NOM'],
      date_de_naissance_array = ['', 'DateNaissance', 'Naissance', 'datenaissance', 'naissance'],
      pays_array = ['', 'nationalité', 'pays', 'PAYS'],
      doss_array = ['', 'Dossard', 'doss', 'Doss', 'doss.', 'DOSS', 'DOSSARD'],
      clas_cat = ['Classement par Cat.', 'CLASS/CATEGORIE'],
      cat_array = ['Catégorie', 'Cat', 'Cat.', 'CATÉGORIE', 'CATEGORIE'],
    ...
    fftri_headers_array = [
      ...
      dossard_array = ['', 'Dossard', 'doss', 'Doss', 'doss.', 'DOSSARD'],
      statut_array = [],
      nom_array = ['nom', 'Nom', 'NOM'],
      prénom_array = ['', 'prénom', 'PRENOM', 'PRÉNOM'],
      sexe_array = ['', 'Sx', 'SEXE', 'Sexe'],
      date_de_naissance_array = ['', 'DateNaissance', 'Naissance', 'datenaissance', 'naissance'],
      ...
      rang_club_array = [],
      point_club_array = [],
      rang_final_array = ['Pl.', 'Class', 'Classement', 'CLASSEMENT', 'POSITION'],
      temps_final_array = ['', 'Time', 'Temps', 'TEMPS'],
      rang_par_sexe_array = ['Classement par Sexe'],
      rang_par_catégorie_array = ['Classement par Cat.', 'CLASS/CATEGORIE'],
      distance_épreuve_array = ['', 'Distance', 'distance', 'Dist', 'dist', 'dist.', 'DISTANCE'],
